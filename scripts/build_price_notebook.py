...
CELLS = [
    ...
    nbf.v4.new_markdown_cell(
        ...
        "The right framing for SUENA's actual question — **what's this forecast "
    ...
    nbf.v4.new_markdown_cell(
        ...
        "|---|---|---|---|\n"
        "| **Oracle** | Actual prices | Actual prices | Theoretical max — perfect foresight |\n"
    ...
    nbf.v4.new_code_cell(
        ...
        "\n"
        "totals = {\n"
        "    'Oracle (perfect foresight)': pnl['oracle_pnl'].sum(),\n"
    ...
    nbf.v4.new_markdown_cell(
        ...
        "**The simulation says the opposite.** P50 captures 95.1 % of oracle; "
        ...
        "**Implication for SUENA:** the median forecast is operationally "
    ...
    nbf.v4.new_code_cell(
        ...
        "    mode='lines', name='Oracle (perfect foresight)',\n"
